...
var file_itineraries_proto_rawDesc = []byte{
	...
	0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x16,
	0x5a, 0x14, 0x67, 0x65, 0x6e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x69, 0x74, 0x69, 0x6e, 0x65,
	0x72, 0x61, 0x72, 0x69, 0x65, 0x73, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_itineraries_proto_goTypes = []any{
...
func file_itineraries_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_itineraries_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_itineraries_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_itineraries_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_itineraries_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_itineraries_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_itineraries_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_itineraries_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_itineraries_proto_msgTypes[7].Exporter = func(v any, i int) any {
		...
		file_itineraries_proto_msgTypes[8].Exporter = func(v any, i int) any {
		...
		file_itineraries_proto_msgTypes[9].Exporter = func(v any, i int) any {
		...
		file_itineraries_proto_msgTypes[10].Exporter = func(v any, i int) any {
		...
		file_itineraries_proto_msgTypes[11].Exporter = func(v any, i int) any {
		...
		file_itineraries_proto_msgTypes[12].Exporter = func(v any, i int) any {
		...
		file_itineraries_proto_msgTypes[13].Exporter = func(v any, i int) any {
			switch v := v.(*Author); i {
			case 0:
				return &v.state
			case 1:
		...
		file_itineraries_proto_msgTypes[14].Exporter = func(v any, i int) any {
		...
		file_itineraries_proto_msgTypes[15].Exporter = func(v any, i int) any {
